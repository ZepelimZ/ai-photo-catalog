...
export const CatalogHeader = ({ query, onQuery }: Props) => {
  return (
    <header className="flex flex-col md:flex-row md:items-center gap-4 px-6 md:px-10 py-6 border-b border-border bg-background/60 backdrop-blur-xl sticky top-0 z-20">
      ...
      <div className="flex items-center gap-2">
        <button className="hidden md:flex items-center gap-2 px-4 py-3 rounded-xl bg-muted/60 border border-border text-sm hover:bg-muted transition-colors">
